...
public class ChatRoomConstants {
	...
	public static final String MEG_TYPE_GROUP = "GROUP";
	public static final String MEG_TYPE_USER = "USER";
	public static final String CHAT_USER_TYPING = "CHAT_USER_TYPING";
	public static final String GROUP_CHAT_USER_TYPING = "GROUP_CHAT_USER_TYPING";
